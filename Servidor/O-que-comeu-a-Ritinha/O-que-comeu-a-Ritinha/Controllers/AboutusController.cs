...
namespace O_que_comeu_a_Ritinha.Controllers
{
    public class AboutusController : Controller
    {
        ...
        public async Task<IActionResult> Edit(int id, [Bind("Id,Description,LinkFacebook,LinkInstagram,LinkYoutube")] Aboutus aboutus, List<int> Recipes,
											  IFormFile ImageDescription, IFormFile ImageLogo,
                                              string CurrentImageDescription, string CurrentImageLogo)
        {
            if (id != aboutus.Id)
            {
                return NotFound();
            ...
            if (imageFile != null)
            {
                ...
                if (imageFile.ContentType == "image/png" || imageFile.ContentType == "image/jpeg")
                {
                    ...
                    else
                    {
                        ...
                        imageName = $"image_{Guid.NewGuid()}{fileExtension}";
                    }
