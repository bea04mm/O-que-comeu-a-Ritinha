    ...
    public partial class inicialUpdate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ListIngredientsId = table.Column<int>(type: "int", nullable: false),
                    ListRecipesIId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_IngredientsRecipes", x => new { x.ListIngredientsId, x.ListRecipesIId });
                    table.ForeignKey(
                        name: "FK_IngredientsRecipes_Ingredients_ListIngredientsId",
                        column: x => x.ListIngredientsId,
                        principalTable: "Ingredients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_IngredientsRecipes_Recipes_ListRecipesIId",
                        column: x => x.ListRecipesIId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ListRecipesTId = table.Column<int>(type: "int", nullable: false),
                    ListTagsId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RecipesTags", x => new { x.ListRecipesTId, x.ListTagsId });
                    table.ForeignKey(
                        name: "FK_RecipesTags_Recipes_ListRecipesTId",
                        column: x => x.ListRecipesTId,
                        principalTable: "Recipes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
