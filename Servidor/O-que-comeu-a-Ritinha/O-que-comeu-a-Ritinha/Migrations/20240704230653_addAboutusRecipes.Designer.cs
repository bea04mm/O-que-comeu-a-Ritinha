...
namespace O_que_comeu_a_Ritinha.Migrations
{
    ...
    [Migration("20240704230653_addAboutusRecipes")]
    partial class addAboutusRecipes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("O_que_comeu_a_Ritinha.Models.Aboutus", b =>
                {
                    ...
                    b.Property<string>("ImageInstagram")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ImageLogo")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ImageYoutube")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("ProfileNormal")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ProfileSelected")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("UnFavorites")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("O_que_comeu_a_Ritinha.Models.RecipesTags", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("O_que_comeu_a_Ritinha.Models.RecipesTags", b =>
                {
                    ...
                    b.HasOne("O_que_comeu_a_Ritinha.Models.Tags", "Tag")
                        .WithMany("ListRecipesT")
                        .HasForeignKey("TagFK")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
